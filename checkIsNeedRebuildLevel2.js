...
module.exports = ({ rebuildPackage, tsconfigOutDirAbs, tsConfigRootDirAbs, rebuildDiffTimeMs }) => {
    ...
    const newestModifiedTsFileStatSorted = tsStatsValues.sort((a, b) => b.mtimeMs - a.mtimeMs)
    ...
    const newestBirthJsFileStatSorted = jsStatsValues.sort((a, b) => b.birthtimeMs - a.birthtimeMs)
    const newestBirthJsFileStat = newestBirthJsFileStatSorted[0]
    const newestBirthJsFileMs = newestBirthJsFileStat.birthtimeMs

    const newestFilesTimeDiffMs = (newestBirthJsFileMs + rebuildDiffTimeMs) - newestModifiedTsFileMs
